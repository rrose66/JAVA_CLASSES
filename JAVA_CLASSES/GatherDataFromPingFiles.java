...
public class GatherDataFromPingFiles 
{
...
//				String[] FILES = getTargetFiles(File "C:\\DEV\\FEDE_BOM\\SERVER_MONITORING\\DATA\\PING_AND_TRACE_ROUTE_DATA");
				String strTargetDirectory="Y:\\DATA\\PING\\";
				File dir = new File(strTargetDirectory + "TEMP\\");
//				System.out.println(dir);
				String[] strFileToOpen=dir.list();
				String strTargetFileFullPath=strTargetDirectory + "TEMP\\"+ strFileToOpen[0];
						...
						else
						{
							...
							{	
								...
								else if(strContent.contains("timed out"))
								{
									...
									try
									{
										newFile = new FileWriter(strTargetDirectory + "PingResponseHistory.txt",true);
